...
process.env['E2E_SERVER_FLAVOR'] = process.env['E2E_SERVER_FLAVOR'] ?? 'nestjs';
...
/**
 * Playwright configuration for Example NestJS E2E Tests.
 *
 * Uses the unified test library (libs/e2e-tests) with E2E_SERVER_FLAVOR=nestjs.
