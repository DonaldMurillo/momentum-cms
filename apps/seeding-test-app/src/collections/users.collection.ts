...
/**
 * Users collection for the seeding test app.
 * Stores application-level user profiles linked to Better Auth users.
 */
export const Users = defineCollection({
	...
	hooks: {
		// Strip password field before database insert
