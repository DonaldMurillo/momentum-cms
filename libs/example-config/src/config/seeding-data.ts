			...
			content: [
				...
				},
				{
					...
					features: [
						...
						{ title: 'Fast', description: 'SSR and edge-ready deployment.', icon: '◇' },
						{
							title: 'Extensible',
							description: 'Plugin system for custom functionality.',
							icon: '◈',
						},
						{ title: 'Modern', description: 'Built on Angular 21 with signals.', icon: '○' },
						{ title: 'Accessible', description: 'WCAG 2.1 compliant components.', icon: '◉' },
						{
							title: 'Open Source',
