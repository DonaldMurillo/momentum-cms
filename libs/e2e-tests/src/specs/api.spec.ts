...
test.describe(
	'API Endpoints - Categories Collection (Unauthenticated)',
	{ tag: ['@api', '@crud'] },
	() => {
...
test.describe(
	'API Endpoints - User Notes Collection (Unauthenticated)',
	{ tag: ['@api', '@crud'] },
	() => {
...
test.describe(
	'API Endpoints - Auth Users Collection (Unauthenticated)',
	{ tag: ['@api', '@crud'] },
	() => {
...
test.describe('API Endpoints - Error Handling', { tag: ['@api'] }, () => {
...
test.describe('API CORS Headers', { tag: ['@api', '@security'] }, () => {
