...
export class HdlPopoverTrigger implements OnDestroy {
	readonly hdlPopoverTrigger = input.required<TemplateRef<unknown>>();
	...
	private createOverlay(): void {
		...
		const portal = new TemplatePortal(this.hdlPopoverTrigger(), this.viewContainerRef);
